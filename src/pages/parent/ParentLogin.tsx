...
export default function ParentLogin() {
  ...
  const loginMutation = trpc.parent.login.useMutation({
    ...
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-[#2D2D2D]">Parent Portal</h1>
          <p className="text-sm text-[#6B6560] mt-1">Sign in to register your child</p>
        </div>
